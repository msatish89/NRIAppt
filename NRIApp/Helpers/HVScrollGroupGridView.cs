...
{
    public class HVScrollGroupGridView : Grid
    {
        ...
        public static readonly BindableProperty SelectedCommandProperty =
            BindableProperty.Create("SelectedCommand", typeof(ICommand), typeof(HVScrollGroupGridView), null);

        public static readonly BindableProperty ItemsSourceProperty =
            BindableProperty.Create("ItemsSource", typeof(IEnumerable), typeof(HVScrollGroupGridView), default(IEnumerable<object>), BindingMode.TwoWay, propertyChanged: ItemsSourceChanged);

        public static readonly BindableProperty SelectedItemProperty =
            BindableProperty.Create("SelectedItem", typeof(object), typeof(HVScrollGroupGridView), null, BindingMode.TwoWay, propertyChanged: OnSelectedItemChanged);

        public static readonly BindableProperty ItemTemplateProperty =
            BindableProperty.Create("ItemTemplate", typeof(DataTemplate), typeof(HVScrollGroupGridView), default(DataTemplate));
        ...
        {
            var itemsLayout = (HVScrollGroupGridView)bindable;
            itemsLayout.SetItems();
        }

        public HVScrollGroupGridView()
        {
        ...
        {
            var itemsView = (HVScrollGroupGridView)bindable;
