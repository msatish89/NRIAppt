...
{
   public class LS_Payment_VM : INotifyPropertyChanged
    {
        ...
        public LS_Payment_VM(string adid)
        {
            if (adid !="")
            {
                Bindorderrecipet(adid);
            }
            else
            {
                Withoutpayment = true;
        ...
        public string sAdid = ""; decimal totalamount = 0;
        public LS_Payment_VM(decimal amount,string adid)
        {
            sAdid = adid;
            totalamount = amount;
            Expirymonthlistdata = Expirymonthlist;
            Expiryyearlistdata = Expiryyearlistdata;
            BindBillingdetails(adid);
        ...
        public async void BindBillingdetails(string adid)
        {
            try
            {
                ...
                {
                    billingemail = data.ROW_DATA[0].email;
                    billingcontact = data.ROW_DATA[0].phone;
                    billingaddress = data.ROW_DATA[0].streetname;
                    billingname = data.ROW_DATA[0].contributor;
                    billingcity = data.ROW_DATA[0].city+", "+data.ROW_DATA[0].country;
                    billingcountry = data.ROW_DATA[0].country;
                    billingzip = data.ROW_DATA[0].zipcode;
