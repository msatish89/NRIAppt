...
[assembly: ExportRenderer(typeof(CustomEntry), typeof(CustomEntryRenderer_))]
namespace NRIApp.Droid.CustomRenderers
{
    public class CustomEntryRenderer_ : EntryRenderer
    {
        CustomEntry element;
        public CustomEntryRenderer_(Context context) : base(context)
        {
        }
